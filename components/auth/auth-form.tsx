...
export default function AuthForm() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      // Only handle the auth signup part here
      // The profile creation will be handled in the auth callback route
      ...
      if (authData.session) {
        ...
        // Redirect to the callback route to handle profile creation
        router.push(`/auth/callback?code=${authData.session.access_token}`)
      } else {
